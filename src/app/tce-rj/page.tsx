...
const CTA_LINK = "https://wa.me/5588988058933?text=Ol%C3%A1%2C%20Francisco%21%20Vi%20a%20mentoria%20para%20o%20TCE-RJ%20e%20tenho%20interesse.%20Pode%20me%20dar%20mais%20informa%C3%A7%C3%B5es%3F"
...
const faqs = [
  {
    ...
    answer: "Vale — e muito. Quem começa antes do edital estuda com calma, constrói a base e chega à reta final com confiança. Quem espera o edital sair estuda em pânico. A diferença aparece no resultado.",
  },
  {
  ...
  },
  {
    ...
    answer: "A remuneração no TCE-RJ pode chegar a R$ 19.793,26. O investimento na mentoria é de R$ 1.497 (ou 12x de R$ 149) — uma fração do seu retorno no primeiro mês de trabalho. Você não está gastando, está investindo.",
  },
  {
...
const benefits = [
  {
    icon: Coins,
    title: "Remuneração de até R$ 19.793,26",
    description: "Vencimento-base de R$ 9.896,63 com gratificação de até 100% — podendo chegar a R$ 19.793,26, além de outros benefícios. Um dos melhores pacotes de remuneração entre os Tribunais de Contas do Brasil.",
  },
  {
    icon: BadgeCheck,
    title: "Banca provável: CEBRASPE",
    description: "Tudo indica que a CEBRASPE será a banca do TCE-RJ — e esse é exatamente o território onde meu histórico fala mais alto. Três aprovações em concursos de controle elaborados pela CEBRASPE, incluindo o 1º lugar no TCE-PA.",
  },
  {
    icon: ShieldCheck,
  ...
  {
    icon: Clock,
    title: "Edital ainda não publicado — e isso é vantagem",
    description: "Quem começa agora estuda com calma, sem a pressão de um cronograma apertado. Quando o edital sair, você já estará à frente dos demais candidatos.",
  },
  {
    icon: CalendarClock,
    title: "Diversas especialidades — uma oportunidade",
    description: "O TCE-RJ abre vagas para Controle Externo, Direito, Ciências Contábeis, Ciências Atuariais, Engenharia Civil e Tecnologia da Informação. Uma ampla janela de entrada, independentemente da sua formação.",
  },
]
...
const offerings = [
  {
    ...
    description:
      "Esqueça o plano genérico que serve para todo mundo e não funciona para ninguém. Você recebe um planejamento feito exclusivamente para você — baseado nos temas mais cobrados pela CEBRASPE nos Tribunais de Contas, no seu tempo disponível e na sua especialidade de formação.",
    bonus: false,
  },
  {
    icon: MessageCircle,
  ...
  },
  {
    ...
    description:
      "Quando o edital do TCE-RJ sair, a gente se reúne ao vivo para dissecar tudo — disciplinas por especialidade, pesos, cronograma e o que priorizar. Você não vai precisar interpretar o edital sozinho.",
    bonus: false,
  },
  {
    icon: Crosshair,
...
const approvals = [
  {
    ...
    description: "Aprovado em 1º lugar nas provas objetivas e discursivas aos 23 anos, em um concurso elaborado pela mesma banca apontada como provável para o TCE-RJ.",
  },
  {
    icon: Medal,
    title: "TCE-PB — Aprovado (CEBRASPE)",
    description: "Mais uma aprovação em Tribunal de Contas com concurso elaborado pela CEBRASPE.",
  },
  {
    icon: CheckCircle2,
...
const specialties = [
  {
    ...
    title: "Controle Externo — Geral",
    description: "Nível superior em qualquer área e 2 anos de prática profissional.",
  },
  {
    icon: ChartNoAxesCombined,
    title: "Ciências Atuariais",
    description: "Graduação em Ciências Atuariais, registro no órgão de classe e 2 anos de prática.",
  },
  {
    icon: Calculator,
    title: "Ciências Contábeis",
    description: "Graduação em Ciências Contábeis, registro no CRC e 2 anos de prática.",
  },
  {
    icon: Scale,
    title: "Direito",
    description: "Graduação em Direito, inscrição na OAB (ou documento de incompatibilidade) e 2 anos de prática.",
  },
  {
    icon: HardHat,
    title: "Engenharia Civil",
    description: "Graduação em Engenharia Civil, registro ativo no CREA e 2 anos de prática.",
  },
  {
    icon: Laptop,
    title: "Tecnologia da Informação — Controle Externo",
    description: "Graduação em Ciência da Computação, Engenharia de Sistemas, Engenharia da Computação ou área correlata e 2 anos de prática.",
  },
  {
    icon: Network,
    title: "Tecnologia da Informação — Organizacional",
    description: "Graduação em Ciência da Computação, Engenharia de Sistemas, Engenharia da Computação ou área correlata.",
  },
]

export default function TceRjPage() {
  return (
      ...
      <section className="relative flex flex-col items-center justify-center min-h-[92dvh] text-center px-5 pt-16 pb-20 md:py-28 overflow-hidden bg-gradient-to-br from-[#1e1f5c] via-[#2e2f83] to-[#1e1f5c]">
        ...
        <div className="relative z-10 w-full max-w-4xl mx-auto flex flex-col items-center gap-6 md:gap-8">
          <Badge className="h-fit text-xs sm:text-sm px-4 py-1.5 sm:px-5 sm:py-2 font-semibold tracking-wide bg-[#ff4b00] text-white hover:bg-[#e64300] border-none shadow-lg shadow-[#ff4b00]/20 transition-all max-w-[90vw] whitespace-normal text-center leading-snug">
            🚨 TCE-RJ com concurso previsto — banca provável CEBRASPE. Prepare-se agora.
          </Badge>
          ...
          <h1 className="text-[1.75rem] sm:text-4xl md:text-6xl lg:text-7xl font-extrabold text-white leading-tight tracking-tight w-full">
            O TCE-RJ está chegando.{" "}
            <br className="hidden md:block" />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#ff4b00] to-[#ff7a45]">Você vai estar pronto?</span>
          </h1>

          <p className="text-base sm:text-lg md:text-2xl text-slate-300 max-w-3xl leading-relaxed font-light">
            Concurso previsto para Auditor de Controle Externo com remuneração de até{" "}
            <span className="font-bold text-white">R$ 19.793,26</span>. O edital ainda não foi publicado — ou seja, você tem tempo de chegar à frente. Mentoria de 6 meses com acompanhamento direto de um Auditor aprovado em 4 concursos.
          </p>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-10 md:mb-16 space-y-3">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-5xl font-extrabold text-[#1e1f5c] tracking-tight">
              Vale a pena estudar para o TCE-RJ?
            </h2>
          </div>
      ...
      <section className="py-16 md:py-24 px-5 md:px-6 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12 md:mb-16 space-y-4">
            ...
            <h2 className="text-3xl md:text-5xl font-extrabold text-[#1e1f5c] tracking-tight">
              Para qual especialidade você pode se inscrever?
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 md:gap-6">
            {specialties.map((item) => {
              ...
              return (
                <div
                  key={item.title}
                  className="flex items-start gap-4 p-6 md:p-7 rounded-3xl bg-slate-50 border border-slate-200 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-300"
                >
                  <div className="flex-shrink-0 w-12 h-12 rounded-2xl bg-[#f0f1fa] flex items-center justify-center text-[#2e2f83]">
                    <Icon className="w-6 h-6" />
                  </div>
                  <div>
                    <h3 className="font-bold text-lg text-[#1e1f5c] mb-2 leading-tight">{item.title}</h3>
          ...
          <p className="mt-12 text-center text-lg md:text-xl font-semibold text-[#1e1f5c]">
            Independentemente da sua especialidade, o método é o mesmo — e os resultados também.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24 px-5 md:px-6 mb-8 md:mb-12 bg-white relative overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto text-center relative z-10 flex flex-col items-center">
          ...
          <h2 className="text-3xl md:text-5xl font-extrabold text-[#1e1f5c] mb-6 tracking-tight">
            O edital ainda não saiu — e este é o melhor momento para começar.
          </h2>
          <p className="text-slate-600 text-xl leading-relaxed mb-10">
            Quem entrar agora chegará ao edital com a base construída, o plano ajustado e meses de vantagem sobre quem decidir esperar. Com remuneração de até R$ 19.793,26 e banca provável CEBRASPE, o TCE-RJ é uma das maiores oportunidades entre os Tribunais de Contas do Brasil em 2026.
          </p>
