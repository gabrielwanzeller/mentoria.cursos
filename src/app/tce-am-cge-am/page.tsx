...
const benefits = [
  {
    icon: Coins,
    title: "Salários acima de R$ 15 mil",
    description: "Cargos de alto nível com estabilidade total e benefícios reais.",
  },
  {
    icon: BadgeCheck,
  ...
  {
    icon: Clock,
    title: "Editais previstos para os próximos 6 meses",
    description: "TCE-AM com abertura autorizada. CGE-AM com comissão formada e 50 vagas previstas. A janela está aberta — e quem estudar agora chega preparado, não desesperado.",
  },
  {
    icon: CalendarClock,
...
const approvals = [
  ...
  },
  {
    ...
    description: "Mais uma aprovação em Tribunal de Contas — método que se repete.",
  },
  {
    icon: CheckCircle2,
...
export default function TceAmCgeAmPage() {
  return (
      ...
      <section className="relative flex flex-col items-center justify-center min-h-[92dvh] text-center px-5 pt-16 pb-20 md:py-28 overflow-hidden bg-gradient-to-br from-[#1e1f5c] via-[#2e2f83] to-[#1e1f5c]">
        ...
        <div className="relative z-10 w-full max-w-4xl mx-auto flex flex-col items-center gap-6 md:gap-8">
          ...
          <p className="text-base sm:text-lg md:text-2xl text-slate-300 max-w-3xl leading-relaxed font-light">
            TCE-AM e CGE-AM — mais de 80 vagas previstas para Auditor, Analista e Técnico com salários acima de{" "}
            <span className="font-bold text-white">R$ 15 mil</span>. Editais previstos para os próximos 6 meses. Quem começa agora chega na frente.
          </p>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-10 md:mb-16 space-y-3">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-5xl font-extrabold text-[#1e1f5c] tracking-tight">
              Vale a pena estudar para o TCE-AM e CGE-AM?
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="flex flex-col items-start text-left space-y-6">
              ...
              <p className="text-slate-300 text-lg md:text-xl leading-relaxed">
                ...
                aqui passando pelos mesmos concursos que você quer passar. O meu método é real, testado em 4 aprovações e construído para encurtar o seu caminho.
              </p>
      ...
      <section className="py-16 md:py-24 px-5 md:px-6 mb-8 md:mb-12 bg-white relative overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto text-center relative z-10 flex flex-col items-center">
          ...
          <h2 className="text-3xl md:text-5xl font-extrabold text-[#1e1f5c] mb-6 tracking-tight">
            Os editais chegam nos próximos 6 meses.
          </h2>
          <p className="text-slate-600 text-xl leading-relaxed mb-10">
            TCE-AM com abertura autorizada. CGE-AM com comissão formada. Dois concursos. Um estado. Mais de 80 vagas. Quem entrar agora chega com 6 meses de vantagem sobre quem vai esperar o edital sair.
          </p>
      ...
      <section className="py-16 md:py-24 px-5 md:px-6 bg-[#1e1f5c]">
        <div className="max-w-lg mx-auto text-center flex flex-col items-center gap-6">
          ...
          <div className="flex flex-col items-center gap-2">
            <p className="text-slate-200 text-xl font-semibold">Mentoria completa — 6 meses</p>
          ...
          <p className="text-slate-300 text-base font-medium">Vagas limitadas para acompanhamento direto.</p>
          <a href={CTA_LINK} className="inline-block group w-full sm:w-auto" data-gtm="click_whatsapp">
