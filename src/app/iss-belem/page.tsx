...
const testimonials = [
  ...
  },
  {
    ...
    note: "Vai participar ao vivo da turma do ISS Belém.",
    featured: true,
  },
  {
    name: "Maria Sena",
...
const faqs = [
  {
    ...
    answer: "Vale, e muito. É o primeiro concurso da história da SEFIN Belém — não existe prova anterior para copiar. Quem começa antes constrói a base com calma. Quem espera o edital sair estuda em pânico.",
  },
  {
    question: "Consigo estudar sozinho?",
    answer: "Talvez. Mas quanto tempo você vai perder descobrindo o que funciona, sem nenhum concurso anterior para servir de referência? Já passei em 4 concursos públicos, incluindo um do mesmo perfil de cargo — ISS Sobral.",
  },
  {
    question: "Sou iniciante. É pra mim?",
    answer: "É exatamente para você. Sendo o primeiro concurso da SEFIN Belém, todo mundo começa do zero. A diferença é ter o direcionamento certo desde o primeiro dia.",
  },
  {
  ...
  },
  {
    ...
    answer: "Nenhuma mentoria garante aprovação. O que garanto é o melhor método, material completo e acompanhamento direto de quem passou em 4 concursos públicos. O resto depende de você.",
  },
]
...
const benefits = [
  {
    icon: Coins,
    title: "Salário líquido acima de R$ 27 mil",
    description: "Cargo de Auditor Fiscal da Receita Municipal, com remuneração inicial de R$ 5.513,14 e líquido real, com todas as verbas, entre R$ 11.767,43 e R$ 27.354,34, segundo o Portal da Transparência.",
  },
  {
    icon: BadgeCheck,
    title: "Primeiro concurso da história da SEFIN Belém",
    description: "Nunca houve um concurso antes. Não existe uma prova anterior para comparar — quem passa agora entra para a história do órgão.",
  },
  {
    icon: ShieldCheck,
  ...
  {
    icon: Clock,
    title: "Comissão formada, edital iminente",
    description: "Comissão formada em agosto de 2026. A janela de preparação está aberta agora — e quem estuda antes de o edital sair chega à prova com meses de vantagem.",
  },
  {
    icon: CalendarClock,
    title: "Um concurso raro, sem histórico",
    description: "Sem edital anterior para servir de base, a maioria dos candidatos vai estudar no escuro. Quem tem o direcionamento certo sai na frente de quem está tateando.",
  },
]
...
const offerings = [
  {
    ...
    description:
      "Esqueça o plano genérico que serve para todo mundo e não funciona para ninguém. Você recebe um planejamento feito exclusivamente para você, baseado no que mais cai em concursos fiscais municipais e no seu tempo disponível.",
    bonus: false,
  },
  {
    icon: MessageCircle,
  ...
  },
  {
    ...
    description:
      "A gente se encontra com a turma limitada, ao vivo. Direcionamento de quem passou em 4 concursos públicos, incluindo o ISS Sobral, mesmo perfil de cargo que a SEFIN Belém vai cobrar.",
    bonus: false,
  },
  {
    icon: BookOpenCheck,
  ...
  },
  {
    ...
    description:
      "Assim que o edital da SEFIN Belém sair, a gente se reúne ao vivo para dissecar tudo: disciplinas, pesos, cronograma e prioridades. Você não interpreta o edital sozinho.",
    bonus: false,
  },
  {
    icon: Crosshair,
    title: "🎁 Bônus: Raio-X de Concursos Fiscais",
    description:
      "Análise de milhares de questões de legislação tributária municipal aplicadas nos principais concursos fiscais do país.",
    bonus: true,
  },
  {
    icon: Mic2,
    title: "🎤 Bônus exclusivo: participação do Victor Cortez",
    description: "Meu aluno aprovado em 1º lugar como Auditor da SEFA-PA vai participar ao vivo da mentoria, contando como se preparou para esse mesmo perfil de prova.",
    bonus: true,
  },
]
...
const approvals = [
  ...
  },
  {
    ...
    description: "Mais uma aprovação em Tribunal de Contas.",
  },
  {
    icon: CheckCircle2,
  ...
  },
  {
    ...
    description:
      "Aprovação na área fiscal municipal — o mesmo tipo de prova que a SEFIN Belém vai cobrar.",
  },
]
      ...
      <section className="relative flex flex-col items-center justify-center min-h-[92dvh] text-center px-5 pt-16 pb-20 md:py-28 overflow-hidden bg-gradient-to-br from-[#1e1f5c] via-[#2e2f83] to-[#1e1f5c]">
        ...
        <div className="relative z-10 w-full max-w-4xl mx-auto flex flex-col items-center gap-6 md:gap-8">
          ...
          <h1 className="text-[1.75rem] sm:text-4xl md:text-6xl lg:text-7xl font-extrabold text-white leading-tight tracking-tight w-full">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#ff4b00] to-[#ff7a45]">Você está preparado?</span>
          </h1>

          <p className="text-base sm:text-lg md:text-2xl text-slate-300 max-w-3xl leading-relaxed font-light">
            Auditor Fiscal da Receita Municipal — salário líquido que pode passar de{" "}
            <span className="font-bold text-white">R$ 27 mil</span>. A SEFIN Belém nunca abriu concurso antes. Comissão formada em agosto de 2026, edital iminente. Quem começa agora chega na frente de quem nunca disputou essa banca.
          </p>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-10 md:mb-16 space-y-3">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-5xl font-extrabold text-[#1e1f5c] tracking-tight">
              Vale a pena estudar para o ISS Belém?
            </h2>
          </div>
            ...
            {testimonials.map((t, i) => (
              <div
                ...
                className={`flex flex-col gap-4 p-8 rounded-3xl border shadow-sm hover:shadow-xl transition-all duration-300 relative ${
                  t.featured
                    ? "bg-orange-50 border-[#ff4b00] ring-2 ring-[#ff4b00]/20"
                    : "bg-white border-slate-200"
                }`}
              >
                {t.featured && (
                  <span className="absolute top-5 right-5 text-xs font-bold uppercase tracking-wider text-[#ff4b00] bg-orange-100 px-3 py-1 rounded-full">
      ...
      <section className="py-16 md:py-24 px-5 md:px-6 mb-8 md:mb-12 bg-white relative overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto text-center relative z-10 flex flex-col items-center">
          ...
          <h2 className="text-3xl md:text-5xl font-extrabold text-[#1e1f5c] mb-6 tracking-tight">
            O primeiro concurso da SEFIN Belém está chegando.
          </h2>
          <p className="text-slate-600 text-xl leading-relaxed mb-10">
            A SEFIN Belém nunca abriu concurso antes. Comissão formada, edital iminente. Quem entra agora chega com meses de vantagem sobre quem só vai começar depois que o edital for publicado.
          </p>
