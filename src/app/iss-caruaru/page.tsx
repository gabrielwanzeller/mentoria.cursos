...
const CTA_LINK = "https://wa.me/5588988058933?text=Ol%C3%A1%2C%20Francisco%21%20Vi%20a%20mentoria%20para%20o%20ISS%20Caruaru%20e%20tenho%20interesse.%20Pode%20me%20dar%20mais%20informa%C3%A7%C3%B5es%3F"
...
const faqs = [
  ...
  },
  {
    ...
    answer: "O Auditor Fiscal de Caruaru tem remuneração inicial acima de R$ 20 mil, conforme o Portal da Transparência do Município. O investimento na mentoria é de R$ 997 — uma fração do seu retorno no primeiro mês de trabalho. Você não está gastando, está investindo.",
  },
  {
    question: "E se eu não for aprovado?",
    answer: "Nenhuma mentoria garante aprovação. O que garanto é o melhor método, material completo e acompanhamento direto de quem passou em 4 concursos públicos, incluindo o ISS Sobral. O resto depende de você.",
  },
]
...
const benefits = [
  {
    icon: Coins,
    title: "Auditor Fiscal: acima de R$ 20 mil",
    description: "Vencimento-base de R$ 6.000,00 com gratificações que elevam a remuneração inicial para acima de R$ 20 mil, conforme o Portal da Transparência de Caruaru. Analista Fiscal: R$ 2.500,00 mais gratificação de produtividade de até R$ 3.750,00. Cargo efetivo, estabilidade total e carreira na administração tributária do maior município do interior de Pernambuco.",
  },
  {
    icon: BadgeCheck,
    title: "Banca definida: IBAM",
    description: "A banca está definida — e você já sabe o que esperar. Prova objetiva com 40 questões e prova dissertativa. Quem começa agora estuda com direcionamento certeiro para cada disciplina.",
  },
  {
    icon: ShieldCheck,
  ...
  },
  {
    ...
    description: "Inscrições abertas até 08 de outubro. Provas objetiva e dissertativa em 29 de novembro. Quem começa agora estuda com calma e com método. Quem deixa para a reta final estuda no desespero.",
  },
  {
    icon: CalendarClock,
    title: "Caruaru-PE — oportunidade real no interior",
    description: "20 vagas para quem quer construir carreira fiscal no maior município do interior de Pernambuco. Cargo efetivo, estabilidade e progressão na carreira tributária municipal.",
  },
]
...
const offerings = [
  {
    ...
    description:
      "Esqueça o plano genérico que serve para todo mundo e não funciona para ninguém. Você recebe um planejamento feito exclusivamente para você — baseado nas disciplinas cobradas pelo IBAM no ISS Caruaru: Conhecimentos Específicos, Português, Raciocínio Lógico e Informática, considerando o seu tempo disponível.",
    bonus: false,
  },
  {
    icon: MessageCircle,
  ...
  },
  {
    ...
    description:
      "A gente se encontra com a turma limitada, ao vivo. Você recebe direcionamento de quem passou em 4 concursos públicos — incluindo o ISS Sobral, cargo idêntico ao que você quer agora.",
    bonus: false,
  },
  {
    icon: BookOpenCheck,
...
const approvals = [
  {
    ...
    description: "Passei no ISS Sobral — o mesmo cargo que você quer agora. Conheço a prova fiscal municipal por dentro.",
  },
  {
    icon: Trophy,
...
export default function IssCaruaruPage() {
  return (
    <main className="min-h-screen font-sans selection:bg-[#ff4b00] selection:text-white pb-12">
      ...
      <section className="relative flex flex-col items-center justify-center min-h-[92dvh] text-center px-5 pt-16 pb-20 md:py-28 overflow-hidden bg-gradient-to-br from-[#1e1f5c] via-[#2e2f83] to-[#1e1f5c]">
        ...
        <div className="relative z-10 w-full max-w-4xl mx-auto flex flex-col items-center gap-6 md:gap-8">
          <Badge className="h-fit text-xs sm:text-sm px-4 py-1.5 sm:px-5 sm:py-2 font-semibold tracking-wide bg-[#ff4b00] text-white hover:bg-[#e64300] border-none shadow-lg shadow-[#ff4b00]/20 transition-all max-w-[90vw] whitespace-normal text-center leading-snug">
            🚨 ISS Caruaru com edital publicado — inscrições até 08 de outubro. Prova em 29 de novembro.
          </Badge>
          ...
          <p className="text-base sm:text-lg md:text-2xl text-slate-300 max-w-3xl leading-relaxed font-light">
            20 vagas para Auditor Fiscal e Analista Fiscal. Remuneração inicial acima de{" "}
            <span className="font-bold text-white">R$ 20 mil</span> para Auditor. Prova em 29 de novembro. Banca IBAM. Estude com um Auditor do TCE-PE e chegue preparado.
          </p>
          ...
          <div className="flex flex-col items-center gap-3 md:gap-4 mt-2 md:mt-4 w-full">
            ...
            <p className="text-white/60 text-sm font-medium">Vagas limitadas. Reta final com direcionamento real.</p>
          </div>
        </div>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-10 md:mb-16 space-y-3">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-5xl font-extrabold text-[#1e1f5c] tracking-tight">
              Vale a pena estudar para o ISS Caruaru?
            </h2>
          </div>
      ...
      <section className="py-16 md:py-24 px-5 md:px-6 mb-8 md:mb-12 bg-white relative overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto text-center relative z-10 flex flex-col items-center">
          ...
          <h2 className="text-3xl md:text-5xl font-extrabold text-[#1e1f5c] mb-6 tracking-tight">
            Prova em 29 de novembro. O tempo está correndo.
          </h2>
          <p className="text-slate-600 text-xl leading-relaxed mb-10">
            Banca definida. Edital publicado. Inscrições até 08 de outubro. Quem entrar agora estuda com método e chega confiante. Quem esperar chegará sem base — e sentirá isso na hora da prova.
          </p>
      ...
      <section className="py-16 md:py-24 px-5 md:px-6 bg-[#1e1f5c]">
        <div className="max-w-lg mx-auto text-center flex flex-col items-center gap-6">
          ...
          <div className="flex flex-col items-center gap-2">
            <p className="text-slate-200 text-xl font-semibold">Reta Final ISS Caruaru</p>
            <p className="text-5xl md:text-6xl font-extrabold text-white">R$ 997</p>
            <p className="text-slate-300 text-lg">à vista ou 12x de <span className="font-semibold text-white">R$ 99</span></p>
          </div>
          <p className="text-slate-300 text-base font-medium">Somente 5 vagas. Prova em 29 de novembro.</p>
          <a href={CTA_LINK} className="inline-block group w-full sm:w-auto" data-gtm="click_whatsapp">
      ...
      <footer className="py-8 text-center text-slate-500 text-sm border-t border-slate-200 mt-auto bg-slate-50">
        <p className="font-semibold text-slate-700 mb-1">Somente 5 vagas para a Reta Final ISS Caruaru.</p>
